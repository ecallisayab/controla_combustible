                                    ...
                                    <table class="table table-stripped table-hover table-sm">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-success btn-sm" href="AlmacenControlador?accion=editar&id=${item.id}" title="Editar"><span class="fa fa-edit"></span></a>
                                                    <a class="btn btn-danger btn-sm" href="AlmacenControlador?accion=eliminar&id=${item.id}" title="Eliminar"><span class="fa fa-trash"></span></a>
                                                </td>
                                            </tr>
                                            </c:forEach>
                                        </tbody>
