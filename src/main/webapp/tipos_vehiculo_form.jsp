...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <jsp:include page="META-INF/componentes/menu.jsp">
            <jsp:param name="opcion" value="catalogo_tipos_vehiculo"/>
        </jsp:include>
        <!-- End of Sidebar -->
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <!-- Card Body -->
                                <div class="card-body">
                                    <form action="TipoVehiculoControlador" method="POST" autocomplete="off">
                                        <input class="form-control" type="hidden" name="id" id="txtId" value="${tipos_vehiculo.id}">
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    <label id="txtNombre">Nombre</label>
                                                    <input class="form-control" type="text" name="nombre" id="txtNombre" value="${tipos_vehiculo.nombre}" required>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="estado" id="cboEstado" required>
                                                        ...
                                                        <option value="1" <c:if test="${tipos_vehiculo.estado == 1}">selected</c:if>>ACTIVADO</option>
                                                        <option value="0" <c:if test="${tipos_vehiculo.estado == 0}">selected</c:if>>DESACTIVADO</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
