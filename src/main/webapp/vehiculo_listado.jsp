                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h5 class="m-0 font-weight-bold">Listado de vehículos</h5>
                                    <a class="btn btn-primary text-right" href="VehiculoControlador?accion=nuevo">
                                ...
                                <div class="card-body">
                                    <table class="table table-stripped table-border table-sm">
                                        ...
                                        <tbody>
                                            <c:forEach var="item" items="${vehiculo}">
                                            <tr>
                                                <td>${item.id}</td>
                                                <td>${item.marca}</td>
                                                <td>${item.modelo}</td>
                                                ...
                                                <td>
                                                    <a class="btn btn-success btn-sm" href="VehiculoControlador?accion=editar&id=${item.id}" title="Editar"><span class="fa fa-edit"></span></a>
                                                    <a class="btn btn-danger btn-sm" href="VehiculoControlador?accion=eliminar&id=${item.id}" title="Eliminar"><span class="fa fa-trash"></span></a>
                                                </td>
                                            </tr>
                                            </c:forEach>
                                        </tbody>
