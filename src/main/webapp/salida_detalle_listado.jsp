                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h5 class="m-0 font-weight-bold">Detalle de salida</h5>
                                                    ...
                                                    <div class="btn-group " role="group" aria-label="Button group with nested dropdown">
                                                      <div class="btn-group btn-group-sm" role="group">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                                            <a class="dropdown-item" href="SalidaDetalleControlador?accion=editar&id=${item.id}" title="Editar"><span class="fa fa-edit"></span>&nbsp;Editar</a>
                                                            <a class="dropdown-item" href="SalidaDetalleControlador?accion=eliminar&id=${item.id}" title="Eliminar"><span class="fa fa-trash"></span>&nbsp;Eliminar</a>
                                                        </div>
                                                      </div>
                                                    </div>
                                                </td>
